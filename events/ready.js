...
module.exports = async bot => {
    ...
    // update member counter each x random minutes
    bot.tools.discord.updateCounter(bot);
    bot.tools.javascript.randomInterval(120000, 300000, () => bot.tools.discord.updateCounter(bot));

    bot.tools.discord.updateSlashCommands(bot, false);

    bot.tools.discord.startupGuildCheck(bot);

    bot.logger.info('[BOT LOGGED IN] » no critical problems could be detected...');
};
